    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          <button 
            ...
            className="btn-3d-action animate-pulse-cyan"
            style={{
              width: "42px",
              height: "42px",
              borderRadius: "50%",
              ...
              border: "none",
              borderBottom: "3px solid rgba(16, 217, 210, 0.4)",
              color: "#10d9d2",
              fontSize: "1.1rem",
              display: "flex",
              alignItems: "center",
          ...
          <button 
            ...
            className="btn-3d-action btn-3d-mail animate-pulse-gold"
            style={{
              width: "42px",
              height: "42px",
              borderRadius: "14px",
          ...
          >
            <Fallback3DIcon iconKey="action_mail" fallback="✉️" style={{ fontSize: "1.2rem" }} />
          </button>
        </div>
            ...
            {activeDock.map(key => {
              ...
              return (
                <div 
                  ...
                  title={def.name}
                >
                  <span style={{ fontSize: "1.25rem", lineHeight: "1.2", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <Fallback3DIcon iconKey={`tactic_${key}`} fallback={def.icon} style={{ width: "24px", height: "24px" }} />
                  </span>
                  <span style={{ 
                    fontSize: "0.62rem", 
                    fontWeight: "900", 
        ...
        <button 
          ...
          className="btn-3d-action animate-pulse-green"
          style={{
            display: "flex",
            flexDirection: "column",
            alignItems: "center",
        ...
        >
          <div style={{
            ...
            <Fallback3DIcon iconKey="action_ads" fallback="▶" style={{ fontSize: "1rem" }} />
          </div>
          <span style={{ fontSize: "0.58rem", fontWeight: "800", color: "#ecc94b", marginTop: "4px" }}>+500 ADS</span>
        </button>
      </div>
      ...
      <div style={{
        ...
        <button 
          ...
          className="btn-play-banner-3d btn-play-online-3d"
          style={{
            padding: "14px 20px",
            display: "flex",
            alignItems: "center",
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <div style={{
              ...
              <Fallback3DIcon iconKey="play_online" fallback="🎮" style={{ width: "32px", height: "32px" }} />
            </div>
        ...
        <button 
          ...
          className="btn-play-banner-3d btn-play-friends-3d"
          style={{
            padding: "14px 20px",
            display: "flex",
            alignItems: "center",
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <div style={{
              ...
              <Fallback3DIcon iconKey="play_friends" fallback="👥" style={{ width: "32px", height: "32px" }} />
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
        ...
        <button 
          onClick={onPractice}
          className="btn-play-banner-3d btn-play-practice-3d"
          style={{
            padding: "14px 20px",
            display: "flex",
            alignItems: "center",
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <div style={{
              ...
              <Fallback3DIcon iconKey="play_practice" fallback="🤖" style={{ width: "32px", height: "32px" }} />
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
